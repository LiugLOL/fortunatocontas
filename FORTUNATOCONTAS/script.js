alert('Bem-vindo ao FortunatoContas, aqui, a cada aula desse bendito professor, o site irá atualizar para facilitar a vossa vida! Então, pra começar, coloca o valor do salário do povo aí. ');
var s1 = parseInt(prompt('O salário?'));
var s2 = parseInt(prompt('Seu número?'));
var s3 = parseInt(prompt('Número de Horas extras por dia +o seu número'))
...
console.log(s3, 'Horas extras por dia')
